  ...
  return (
    <CanvasWrapper>
      <group rotation={[0, 0, MathUtils.degToRad(rotation)]}>
        <PlaneNoise ref={meshRef} count={beamNumber} height={beamHeight} material={beamMaterial} width={beamWidth} />
...
>((props, ref) => (
  <MergedPlanes ref={ref} count={props.count} height={props.height} material={props.material} width={props.width} />
));
